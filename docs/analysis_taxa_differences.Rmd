...
We now have data back from the spider diet sequencing: hooray! We don't yet have identifications for the spiders themselves, but even in the absence of these we can do a lot with the data. So far I've only made summary figures: I'm sure for the key findings we can do statistical tests etc for when we're putting them in a manuscript, but right now everything that follows is very exploratory. It seemed worth putting all of this down on 'paper' to convey to you both what I think it shows, and then get some honest thoughts on if you agree with me. Plus its good for us to all have a similar understanding of our data :)
